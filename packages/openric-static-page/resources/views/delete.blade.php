{{--
  Static page delete confirmation -- adapted from Heratio ahg-static-page delete.blade.php (22 lines).
--}}
...
@section('content')
  ...
  <form method="POST" action="{{ route('staticpage.destroy', $slug) }}">
    ...
    <ul class="actions mb-3 nav gap-2">
      ...
      <li>
        <input class="btn atom-btn-outline-danger" type="submit" value="{{ __('Delete') }}">
      </li>
    </ul>
