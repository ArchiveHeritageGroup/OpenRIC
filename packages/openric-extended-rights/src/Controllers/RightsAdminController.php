...
namespace OpenRic\ExtendedRights\Controllers;

use OpenRic\ExtendedRights\Services\ExtendedRightsService;
...
class RightsAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('openric-extended-rights::admin.index', compact('stats', 'expiringEmbargoes', 'reviewDue', 'formOptions'));
    }
    ...
    public function embargoes(Request $request)
    {
        ...
        return view('openric-extended-rights::admin.embargoes', compact('embargoes', 'status', 'formOptions'));
    }
    ...
    public function embargoEdit(Request $request, ?int $id = null)
    {
        ...
        return view('openric-extended-rights::admin.embargo-edit', compact('embargo', 'embargoLog', 'formOptions'));
    }
    ...
    public function orphanWorks(Request $request)
    {
        ...
        return view('openric-extended-rights::admin.orphan-works', compact('orphanWorks', 'status', 'formOptions'));
    }
    ...
    public function orphanWorkEdit(Request $request, ?int $id = null)
    {
        ...
        return view('openric-extended-rights::admin.orphan-work-edit', compact('orphanWork', 'searchSteps', 'formOptions'));
    }
    ...
    public function tkLabels()
    {
        ...
        return view('openric-extended-rights::admin.tk-labels', compact('tkLabels', 'assignments'));
    }
    ...
    public function statements()
    {
        ...
        return view('openric-extended-rights::admin.statements', compact('rightsStatements', 'ccLicenses'));
    }
    ...
    public function report(Request $request)
    {
        ...
        return view('openric-extended-rights::admin.report', compact('type', 'data'));
    }
}
