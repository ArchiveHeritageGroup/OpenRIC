...
class RightsController extends Controller
{
    ...
    public function index(string $slug)
    {
        ...
        return view('openric-extended-rights::rights.index', compact(
    ...
    public function add(string $slug)
    {
        ...
        return view('openric-extended-rights::rights.edit', compact('resource', 'formOptions', 'isNew', 'right'));
    }
    ...
    public function editEmbargo(string $slug)
    {
        ...
        return view('openric-extended-rights::rights.edit-embargo', compact('resource', 'embargo', 'formOptions'));
    }
    ...
    public function tkLabels(Request $request, string $slug)
    {
        ...
        return view('openric-extended-rights::rights.tk-labels', compact('resource', 'availableLabels', 'assignedLabels'));
    }
    ...
    public function orphanWork(Request $request, string $slug)
    {
        ...
        return view('openric-extended-rights::rights.orphan-work', compact('resource', 'orphanWork'));
    }
