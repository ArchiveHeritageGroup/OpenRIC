...
namespace OpenRic\FtpUpload\Controllers;

use OpenRic\FtpUpload\Services\FtpService;
...
class FtpUploadController extends Controller
{
    ...
    const CHUNK_DIR = '/tmp/openric_ftp_chunks';
    ...
    public function index()
    {
        ...
        return view('openric-ftp-upload::index', [
            'title' => 'FTP Upload',
