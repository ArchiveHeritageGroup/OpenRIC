...
namespace OpenRicMetadataExtraction\Services;
...
class MetadataExtractionService
{
    ...
    {
        $content = @file_get_contents($filePath, false, null, 0, 1024 * 512);
        if (!$content) {
            return [];
        }
    ...
    public function extractFromDigitalObject(int $digitalObjectId, string $culture = 'en'): array
    {
        ...
        $uploadsPath = config('openric.uploads_path', '/mnt/nas/openric/archive');
