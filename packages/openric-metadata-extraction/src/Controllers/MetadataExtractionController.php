...
namespace OpenRicMetadataExtraction\Controllers;
...
class MetadataExtractionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('openric-metadata-extraction::index', compact(
            'exifToolAvailable',
            'ffprobeAvailable',
            'pdfinfoAvailable',
            'exifToolVersion',
    ...
    public function view(int $id)
    {
        ...
        return view('openric-metadata-extraction::view', compact(
            'digitalObject',
            'metadata',
            'groupedMetadata',
        ));
    ...
    public function status()
    {
        ...
        return view('openric-metadata-extraction::status', compact(
            'exifToolAvailable',
            'ffprobeAvailable',
            'pdfinfoAvailable',
            'exifToolVersion',
