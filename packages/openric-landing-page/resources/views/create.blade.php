{{-- Create New Landing Page -- adapted from Heratio ahg-landing-page::create --}}
    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('landing-page.create') }}">
        ...
        <div class="mb-3">
          ...
          <div class="form-text">URL-friendly identifier (auto-generated from name if left empty)</div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="form-text">This page will be shown when visitors access the root landing URL</div>
        </div>
