{{-- Block: Header Section -- adapted from Heratio ahg-landing-page --}}
@php
...
$siteTitle = config('app.name', 'OpenRiC');
    ...
    <div class="d-flex justify-content-between align-items-center py-3">
      ...
      @if ($showNav)
        <nav class="d-none d-md-flex gap-3">
          <a href="{{ url('/browse') }}" class="text-decoration-none text-dark">Browse</a>
          <a href="{{ url('/search/advanced') }}" class="text-decoration-none text-dark">Search</a>
          <a href="{{ url('/repository') }}" class="text-decoration-none text-dark">Repositories</a>
        </nav>
    ...
    @if ($showNav)
      ...
      <div class="collapse d-md-none pb-3" id="mobileNav">
        <nav class="d-flex flex-column gap-2">
          <a href="{{ url('/browse') }}" class="text-decoration-none">Browse</a>
          <a href="{{ url('/search/advanced') }}" class="text-decoration-none">Search</a>
          <a href="{{ url('/repository') }}" class="text-decoration-none">Repositories</a>
        </nav>
      </div>
    @endif
  </div>
