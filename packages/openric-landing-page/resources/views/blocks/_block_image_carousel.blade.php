{{-- Block: Image Carousel -- adapted from Heratio ahg-landing-page --}}
@php
...
$carouselId = 'carousel-' . ($block->id ?? uniqid());
@endphp

@if (!$collectionSlug)
  <p class="text-muted">No collection configured. Edit this block to select a collection.</p>
@else
  ...
  @if ($showViewAll && $collectionSlug)
    <div class="text-center mt-3">
      <a href="{{ url('/collection/' . $collectionSlug) }}" class="btn btn-outline-primary">
