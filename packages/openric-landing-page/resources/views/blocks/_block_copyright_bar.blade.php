{{-- Block: Copyright Bar -- adapted from Heratio ahg-landing-page --}}
@php
$copyright = $config['copyright_text'] ?? '(c) ' . date('Y') . ' All Rights Reserved';
$poweredBy = $config['powered_by'] ?? 'OpenRiC';
$poweredByUrl = $config['powered_by_url'] ?? 'https://github.com/OpenRiC/OpenRiC';
