{{-- Block: Featured Items -- adapted from Heratio ahg-landing-page --}}
@php
...
$carouselId = 'featured-' . ($block->id ?? uniqid());
@endphp
...
@else
  ...
  @if ($showViewAll)
    <div class="text-center mt-3">
      <a href="{{ url('/collection/' . $collectionId) }}" class="btn btn-outline-primary">
