{{-- Block: Footer Section -- adapted from Heratio ahg-landing-page --}}
@php
      ...
      @if ($columns >= 2)
        <div class="col-md-{{ 12 / $columns }}">
          ...
          <ul class="list-unstyled small mb-0">
            <li class="mb-1"><a href="{{ url('/browse') }}" class="text-decoration-none opacity-75" style="color: {{ $textColor }};">Browse Collections</a></li>
            <li class="mb-1"><a href="{{ url('/repository') }}" class="text-decoration-none opacity-75" style="color: {{ $textColor }};">Repositories</a></li>
            <li class="mb-1"><a href="{{ url('/search/advanced') }}" class="text-decoration-none opacity-75" style="color: {{ $textColor }};">Advanced Search</a></li>
