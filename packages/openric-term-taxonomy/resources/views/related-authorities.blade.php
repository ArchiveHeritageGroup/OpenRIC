...
@section('sidebar')
  ...
  @include('openric-term-taxonomy::_sidebar', [
      'resource' => $resource,
      'showTreeview' => true,
      'search' => $search,
      'aggs' => $aggs,
...
@section('title')
  ...
  @include('openric-term-taxonomy::_navigate-related', ['resource' => $resource])

  @include('openric-term-taxonomy::_errors', ['errorSchema' => $errorSchema])
...
@section('context-menu')
  ...
  <nav>
    ...
    @include('openric-term-taxonomy::_right-context-menu', ['resource' => $resource, 'results' => $pager->getNbResults()])
...
@section('content')
  ...
  <div id="content">
    @include('openric-term-taxonomy::_fields', ['resource' => $resource])
  </div>

  @include('openric-term-taxonomy::_actions', ['resource' => $resource])
  ...
  <div id="content">
    ...
    @include('openric-term-taxonomy::_direct-terms', [
        'resource' => $resource,
        'aggs' => $aggs,
    ])
