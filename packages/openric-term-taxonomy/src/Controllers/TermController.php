...
namespace OpenRic\TermTaxonomy\Controllers;

use OpenRic\TermTaxonomy\Services\TermBrowseService;
use OpenRic\TermTaxonomy\Services\TermService;
use OpenRic\Core\Pagination\SimplePager;
use OpenRic\Core\Services\SettingHelper;
...
class TermController extends Controller
{
    ...
    public function taxonomyIndex(Request $request)
    {
        ...
        $pager = new \OpenRic\Core\Pagination\SimplePager([
        ...
        return view('openric-term-taxonomy::taxonomy-index', [
    ...
    public function browse(Request $request)
    {
        ...
        return view('openric-term-taxonomy::browse', [
            'pager' => $pager,
    ...
    public function show(Request $request, string $slug)
    {
        ...
        return view('openric-term-taxonomy::show', [
            'term' => $term,
            'taxonomyName' => $taxonomyName,
            'scopeNote' => $scopeNote,
    ...
    public function create(Request $request)
    {
        ...
        return view('openric-term-taxonomy::edit', [
            'term' => null,
            'taxonomies' => $taxonomies,
            'taxonomyName' => $taxonomyName,
    ...
    public function confirmDelete(string $slug)
    {
        ...
        return view('openric-term-taxonomy::delete', [
            'term' => $term,
            'taxonomyName' => $taxonomyName,
        ]);
    }
