...
Route::prefix('graph')->group(function () {
    ...
    Route::get('/entity/{iri}', [GraphController::class, 'entity'])->name('graph.entity')->where('iri', '.*');
    Route::get('/entity/{iri}/json', [GraphController::class, 'entityJson'])->name('graph.entity.json')->where('iri', '.*');
});
