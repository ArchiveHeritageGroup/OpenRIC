...
use OpenRicRic\Controllers\RicController;
...
// Public browse pages
Route::get('/browse', [RicController::class, 'browse'])->name('ric.browse');
Route::get('/browse/records', [RicController::class, 'browseRecords'])->name('ric.browse.records');

// RIC Explorer - public access for standalone site
