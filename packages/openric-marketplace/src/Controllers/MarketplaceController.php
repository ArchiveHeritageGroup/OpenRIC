...
namespace OpenRicMarketplace\Controllers;

use OpenRicMarketplace\Services\MarketplaceService;
...
class MarketplaceController extends Controller
{
    ...
    private function requireAdmin(): void
    {
        ...
        if (!Auth::user()->is_admin) {
            ...
            abort(redirect(route('ahgopenric-marketplace.browse')));
        }
    }
    ...
    private function requireSeller(int $userId): object
    {
        ...
        if (!$seller) {
            abort(redirect(route('ahgopenric-marketplace.seller-register')));
        }
    ...
    public function adminDashboard(Request $request)
    {
        ...
        return view('openric-marketplace::admin-dashboard', compact(
            'stats',
            'recentTransactions',
            'monthlyRevenue',
        ));
    ...
    public function adminListings(Request $request)
    {
        ...
        return view('openric-marketplace::admin-listings', [
    ...
    public function adminListingReview(Request $request)
    {
        ...
        if (!$listingId) {
            return redirect()->route('ahgopenric-marketplace.admin-listings');
        }
        ...
        return view('openric-marketplace::admin-listing-review', compact('listing', 'seller', 'images'));
    }
    ...
    public function adminCategories(Request $request)
    {
        ...
        return view('openric-marketplace::admin-categories', compact('categories', 'sectors'));
    }
    ...
    public function adminCategoriesPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.admin-categories');
    }
    ...
    public function adminCurrencies(Request $request)
    {
        ...
        return view('openric-marketplace::admin-currencies', compact('currencies'));
    }
    ...
    public function adminCurrenciesPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.admin-currencies');
    }
    ...
    public function adminSellers(Request $request)
    {
        ...
        return view('openric-marketplace::admin-sellers', [
    ...
    public function adminSellerVerify(Request $request)
    {
        ...
        if (!$sellerId) {
            return redirect()->route('ahgopenric-marketplace.admin-sellers');
        }
        ...
        return view('openric-marketplace::admin-seller-verify', compact('seller'));
    }
    ...
    public function adminTransactions(Request $request)
    {
        ...
        return view('openric-marketplace::admin-transactions', [
    ...
    public function adminPayouts(Request $request)
    {
        ...
        return view('openric-marketplace::admin-payouts', [
    ...
    public function adminPayoutsBatchPost(Request $request)
    {
        ...
        if (!is_array($selectedIds) || empty($selectedIds)) {
            ...
            return redirect()->route('ahgopenric-marketplace.admin-payouts');
        }
    ...
    public function adminReports(Request $request)
    {
        ...
        return view('openric-marketplace::admin-reports', compact(
            'revenueStats',
            'monthlyRevenue',
            'topSellers',
            'topItems',
    ...
    public function adminReviews(Request $request)
    {
        ...
        return view('openric-marketplace::admin-reviews', [
    ...
    public function adminReviewsPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.admin-reviews');
    }
    ...
    public function adminSettings(Request $request)
    {
        ...
        return view('openric-marketplace::admin-settings', compact('settings'));
    }
    ...
    public function adminSettingsPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.admin-settings');
    }
    ...
    public function browse(Request $request)
    {
        ...
        return view('openric-marketplace::browse', [
    ...
    public function search(Request $request)
    {
        ...
        return view('openric-marketplace::search', [
    ...
    public function listing(Request $request)
    {
        ...
        if (empty($slug)) {
            return redirect()->route('ahgopenric-marketplace.browse');
        }
        ...
        return view('openric-marketplace::listing', compact(
            'listing',
            'seller',
            'images',
            'auction',
    ...
    public function category(Request $request)
    {
        ...
        return view('openric-marketplace::category', [
            'category' => $category,
            'sector' => $sector,
            'listings' => $results['items'],
            'total' => $results['total'],
    ...
    public function sector(Request $request)
    {
        ...
        return view('openric-marketplace::sector', [
            'sector' => $sector,
            'listings' => $results['items'],
            'total' => $results['total'],
            'categories' => $categories,
    ...
    public function featured(Request $request)
    {
        ...
        return view('openric-marketplace::featured', compact('featuredListings', 'featuredCollections'));
    }
    ...
    public function auctionBrowse(Request $request)
    {
        ...
        return view('openric-marketplace::auction-browse', [
    ...
    public function collection(Request $request)
    {
        ...
        return view('openric-marketplace::collection', [
    ...
    public function seller(Request $request)
    {
        ...
        return view('openric-marketplace::seller', [
            'seller' => $seller,
    ...
    public function dashboard(Request $request)
    {
        ...
        if (!$seller) {
            return redirect()->route('ahgopenric-marketplace.seller-register');
        }
        ...
        return view('openric-marketplace::dashboard', [
            'seller' => $seller,
            'stats' => $stats,
    ...
    public function bidForm(Request $request)
    {
        ...
        if ($listing->listing_type !== 'auction') {
            ...
            return redirect()->route('ahgopenric-marketplace.listing', ['slug' => $slug]);
        }
        ...
        return view('openric-marketplace::bid-form', compact(
            'listing',
            'auction',
            'primaryImage',
            'currentBid',
    ...
    public function bidFormPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.bid-form', ['slug' => $slug]);
    }
    ...
    public function enquiryForm(Request $request)
    {
        ...
        return view('openric-marketplace::enquiry-form', compact(
            'listing',
            'primaryImage',
            'prefillName',
            'prefillEmail',
    ...
    public function offerForm(Request $request)
    {
        ...
        return view('openric-marketplace::offer-form', compact('listing', 'primaryImage', 'currencies'));
    }
    ...
    public function offerFormPost(Request $request)
    {
        ...
        if ($result['success']) {
            ...
            return redirect()->route('ahgopenric-marketplace.my-offers');
        }

        session()->flash('error', $result['error']);

        return redirect()->route('ahgopenric-marketplace.offer-form', ['slug' => $slug]);
    }
    ...
    public function reviewForm(Request $request)
    {
        ...
        if (!$txnId) {
            return redirect()->route('ahgopenric-marketplace.my-purchases');
        }
        ...
        return view('openric-marketplace::review-form', compact('transaction'));
    }
    ...
    public function reviewFormPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.review-form', ['id' => $txnId]);
    }
    ...
    public function myBids(Request $request)
    {
        ...
        return view('openric-marketplace::my-bids', [
            'bids' => $result['items'],
            'total' => $result['total'],
            'page' => $page,
            'limit' => $limit,
    ...
    public function myFollowing(Request $request)
    {
        ...
        return view('openric-marketplace::my-following', [
            'sellers' => $result['items'],
            'total' => $result['total'],
            'page' => $page,
            'limit' => $limit,
    ...
    public function myOffers(Request $request)
    {
        ...
        return view('openric-marketplace::my-offers', [
            'offers' => $result['items'],
            'total' => $result['total'],
            'page' => $page,
            'limit' => $limit,
    ...
    public function myPurchases(Request $request)
    {
        ...
        return view('openric-marketplace::my-purchases', [
            'transactions' => $result['items'],
            'total' => $result['total'],
            'page' => $page,
            'limit' => $limit,
    ...
    public function sellerRegister(Request $request)
    {
        ...
        if ($existing) {
            return redirect()->route('ahgopenric-marketplace.dashboard');
        }

        $sectors = ['gallery', 'museum', 'archive', 'library', 'dam'];

        return view('openric-marketplace::seller-register', compact('sectors'));
    }
    ...
    public function sellerProfile(Request $request)
    {
        ...
        return view('openric-marketplace::seller-profile', compact('seller', 'currencies'));
    }
    ...
    public function sellerProfilePost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.seller-profile');
    }
    ...
    public function sellerListings(Request $request)
    {
        ...
        return view('openric-marketplace::seller-listings', [
            'seller' => $seller,
            'listings' => $result['items'],
            'total' => $result['total'],
            'statusFilter' => $statusFilter,
    ...
    public function sellerListingCreate(Request $request)
    {
        ...
        return view('openric-marketplace::seller-listing-create', compact(
            'seller',
            'sectors',
            'categories',
            'currencies',
    ...
    public function sellerListingCreatePost(Request $request)
    {
        ...
        if ($result['success']) {
            ...
            return redirect()->route('ahgopenric-marketplace.seller-listing-images', ['id' => $result['id']]);
        }

        session()->flash('error', $result['error'] ?? 'Failed to create listing.');

        return redirect()->route('ahgopenric-marketplace.seller-listing-create');
    }
    ...
    public function sellerListingEdit(Request $request)
    {
        ...
        $listingId = (int) $request->input('id');
        if (!$listingId) {
            return redirect()->route('ahgopenric-marketplace.seller-listings');
        }
        ...
        return view('openric-marketplace::seller-listing-edit', compact(
            'seller',
            'listing',
            'sectors',
            'categories',
    ...
    public function sellerListingEditPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.seller-listing-edit', ['id' => $listingId]);
    }
    ...
    public function sellerListingImages(Request $request)
    {
        ...
        return view('openric-marketplace::seller-listing-images', compact(
            'listing',
            'images',
            'maxImages',
        ));
    ...
    public function sellerListingImagesPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.seller-listing-images', ['id' => $listingId]);
    }
    ...
    public function sellerCollections(Request $request)
    {
        ...
        return view('openric-marketplace::seller-collections', compact('seller', 'collections'));
    }
    ...
    public function sellerCollectionsPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.seller-collections');
    }
    ...
    public function sellerCollectionCreate(Request $request)
    {
        ...
        return view('openric-marketplace::seller-collection-create', compact('seller'));
    }
    ...
    public function sellerCollectionCreatePost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.seller-collection-create');
    }
    ...
    public function sellerOffers(Request $request)
    {
        ...
        return view('openric-marketplace::seller-offers', [
            'seller' => $seller,
            'offers' => $result['items'],
            'total' => $result['total'],
            'statusFilter' => $statusFilter,
    ...
    public function sellerOfferRespond(Request $request)
    {
        ...
        if (!$offerId) {
            return redirect()->route('ahgopenric-marketplace.seller-offers');
        }
        ...
        return view('openric-marketplace::seller-offer-respond', compact('offer'));
    }
    ...
    public function sellerOfferRespondPost(Request $request)
    {
        ...
        if ($formAction === 'accept') {
            ...
            if ($counterAmount <= 0) {
                ...
                return redirect()->route('ahgopenric-marketplace.seller-offer-respond', ['id' => $offerId]);
            }
    ...
    public function sellerTransactions(Request $request)
    {
        ...
        return view('openric-marketplace::seller-transactions', [
            'seller' => $seller,
            'transactions' => $result['items'],
            'total' => $result['total'],
            'page' => $page,
    ...
    public function sellerTransactionDetail(Request $request)
    {
        ...
        $txnId = (int) $request->input('id');
        if (!$txnId) {
            return redirect()->route('ahgopenric-marketplace.seller-transactions');
        }
        ...
        return view('openric-marketplace::seller-transaction-detail', compact('transaction'));
    }
    ...
    public function sellerTransactionDetailPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.seller-transaction-detail', ['id' => $txnId]);
    }
    ...
    public function sellerEnquiries(Request $request)
    {
        ...
        return view('openric-marketplace::seller-enquiries', [
            'seller' => $seller,
    ...
    public function sellerEnquiriesPost(Request $request)
    {
        ...
        return redirect()->route('ahgopenric-marketplace.seller-enquiries');
    }
    ...
    public function sellerAnalytics(Request $request)
    {
        ...
        return view('openric-marketplace::seller-analytics', [
            'seller' => $seller,
    ...
    public function sellerPayouts(Request $request)
    {
        ...
        return view('openric-marketplace::seller-payouts', [
            'seller' => $seller,
    ...
    public function sellerReviews(Request $request)
    {
        ...
        return view('openric-marketplace::seller-reviews', [
            'seller' => $seller,
            'reviews' => $reviews,
            'ratingStats' => $ratingStats,
        ]);
