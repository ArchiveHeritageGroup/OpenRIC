            ...
            <tbody>
              @foreach($pager->getResults() as $i => $row)
                @php
                  ...
                  $statusLabel = \OpenRicRequestPublish\Controllers\RequestPublishController::getStatusLabel($statusId);
                  $statusBadge = \OpenRicRequestPublish\Controllers\RequestPublishController::getStatusBadgeClass($statusId);
                @endphp
                <tr>
                  <td>
