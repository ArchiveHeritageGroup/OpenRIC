        ...
        <div class="card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="text-center mb-3">
              ...
              @endphp
              <span class="badge {{ \OpenRicRequestPublish\Controllers\RequestPublishController::getStatusBadgeClass($currentStatusId) }} fs-5 px-4 py-2">
                {{ \OpenRicRequestPublish\Controllers\RequestPublishController::getStatusLabel($currentStatusId) }}
              </span>
            </div>
            <hr>
            <div class="mb-3">
