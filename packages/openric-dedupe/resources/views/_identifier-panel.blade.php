...
<div class="card mb-3"><div class="card-header fw-semibold" style="background:var(--bs-primary, #0d6efd);color:#fff"><i class="fas fa-fingerprint me-2"></i>Identifiers</div>
