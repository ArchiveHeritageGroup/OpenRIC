...
class RiCFunctionController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('functions.show', ['iri' => urlencode($iri)])->with('success', 'Function created.');
    }
    ...
    public function update(Request $request, string $iri): RedirectResponse
    {
        ...
        return redirect()->route('functions.show', ['iri' => urlencode($iri)])->with('success', 'Function updated.');
    }
    ...
    public function destroy(string $iri): RedirectResponse
    {
        ...
        return redirect()->route('functions.index')->with('success', 'Function deleted.');
    }
}
