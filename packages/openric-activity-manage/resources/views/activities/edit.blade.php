...
@section('content')
<h1 class="h3 mb-4">Edit Activity</h1>
@include('theme::partials.alerts')
<form method="POST" action="{{ route('activities.update', ['iri' => urlencode($entity['iri'])]) }}">@csrf @method('PUT')
    ...
    <div class="mt-3"><button type="submit" class="btn btn-primary">Save</button> <a href="{{ route('activities.show', ['iri' => urlencode($entity['iri'])]) }}" class="btn btn-secondary">Cancel</a></div>
</form>
@endsection