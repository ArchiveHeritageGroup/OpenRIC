...
@section('content')
<h1 class="h3 mb-4">Create Function</h1>
@include('theme::partials.alerts')
<form method="POST" action="{{ route('functions.store') }}">@csrf
    ...
    <div class="mt-3"><button type="submit" class="btn btn-primary">Create Function</button> <a href="{{ route('functions.index') }}" class="btn btn-secondary">Cancel</a></div>
</form>
@endsection