...
@section('content')
<h1 class="h3 mb-4">Edit Function</h1>
@include('theme::partials.alerts')
<form method="POST" action="{{ route('functions.update', ['iri' => urlencode($entity['iri'])]) }}">@csrf @method('PUT')
    ...
    <div class="mt-3"><button type="submit" class="btn btn-primary">Save</button> <a href="{{ route('functions.show', ['iri' => urlencode($entity['iri'])]) }}" class="btn btn-secondary">Cancel</a></div>
</form>
@endsection