...
@section('title', 'Create Mandate')
@section('content')
<h1 class="h3 mb-4">Create Mandate</h1>
@include('theme::partials.alerts')
<form method="POST" action="{{ route('mandates.store') }}">@csrf
    ...
    <div class="mt-3"><button type="submit" class="btn btn-primary">Create Mandate</button> <a href="{{ route('mandates.index') }}" class="btn btn-secondary">Cancel</a></div>
</form>
@endsection