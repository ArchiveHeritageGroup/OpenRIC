...
@section('content')
<div class="card"><div class="card-header bg-primary text-white"><h5 class="mb-0">Queue Status</h5></div>
<div class="card-body">
  ...
  <table class="table table-striped"><thead><tr><th>Object</th><th>Type</th><th>Status</th><th>Created</th></tr></thead>
