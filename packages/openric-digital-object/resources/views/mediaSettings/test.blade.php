...
@section('content')
<div class="card"><div class="card-header bg-primary text-white"><h5 class="mb-0">Test Media Processing</h5></div>
<div class="card-body">
  <form method="post" action="{{ route('iiif.media-settings.test') }}">@csrf
    ...
    <button type="submit" class="btn btn-outline-primary"><i class="fas fa-play me-1"></i>Run Test</button>
  </form>
  @if(isset($result))
