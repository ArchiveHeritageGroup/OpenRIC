        ...
        <div class="card h-100">
            ...
            <div class="card-footer">
                <div class="btn-group w-100">
                    <a href="{{ route('spectrum.spectrum-export') }}?type={{ $type }}&format=csv&download=1" class="btn btn-outline-primary">
                        <i class="fas fa-file-csv me-1"></i>CSV
                    </a>
                    <a href="{{ route('spectrum.spectrum-export') }}?type={{ $type }}&format=json&download=1" class="btn btn-outline-secondary">
...
<div class="card mt-4">
    ...
    <div class="card-body">
        <ul class="mb-0">
            <li><strong>CSV</strong> - {{ __('Compatible with Excel, suitable for AGSA audit submissions') }}</li>
            <li><strong>JSON</strong> - {{ __('Machine-readable, suitable for system integrations') }}</li>
