...
$currentStateName = is_object($currentState ?? null) ? $currentState->current_state : ($currentState ?? ($configData['initial_state'] ?? 'pending'));
...
<nav aria-label="breadcrumb" class="mb-3">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('spectrum.general') }}">{{ __('General Procedures') }}</a></li>
...
<div class="row">
    <div class="col-md-3">
        ...
        <div class="card mb-4">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item {{ $isActive ? 'active' : '' }}">
                    <a href="{{ route('spectrum.general-workflow', ['procedure_type' => $procId]) }}"
        ...
        <a href="{{ route('spectrum.general') }}" class="btn btn-secondary w-100">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <form method="post" action="{{ route('spectrum.general-workflow') }}" class="row g-3">
                        @csrf
            ...
            <div class="card-body">
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        ...
                        @php $event = is_object($event) ? $event : (object)$event; @endphp
                        <tr>
