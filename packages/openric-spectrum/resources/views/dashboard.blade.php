...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="get" action="{{ route('spectrum.dashboard') }}">
                    <div class="mb-3">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <a href="{{ route('spectrum.my-tasks') }}" class="btn btn-outline-primary w-100 mb-2">
                ...
                <a href="{{ route('spectrum.general') }}" class="btn btn-outline-info w-100 mb-2">
                    <i class="fas fa-building me-1"></i>{{ __('General Procedures') }}
                </a>
                <a href="{{ route('spectrum.data-quality') }}" class="btn btn-outline-success w-100 mb-2">
    ...
    <div class="col-md-9">
        ...
        <div class="card mb-4">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="fas fa-layer-group me-2"></i>{{ __('Spectrum 5.1 Procedures') }}</h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    @php
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card h-100 border-{{ $color }}">
                            <div class="card-body text-center p-3">
                                ...
                                <h6 class="card-title mb-1">{{ $proc['label'] }}</h6>
