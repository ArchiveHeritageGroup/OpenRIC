...
namespace OpenRicMetadataExport\Controllers;
...
class MetadataExportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('openric-metadata-export::index', compact('formats', 'repositories'));
    }
    ...
    public function preview(Request $request)
    {
        ...
        return view('openric-metadata-export::preview', compact('slug', 'format'));
    }
    ...
    public function bulk(Request $request)
    {
        ...
        return view('openric-metadata-export::bulk', compact('format', 'formatInfo', 'repositories'));
    }
}
