...
<div class="card mb-4"><div class="card-header bg-dark text-white"><h5 class="mb-0">Loan Details</h5></div>
...
<section class="nav gap-2 mb-3"><a href="{{ route('gallery.loans') }}" class="btn btn-outline-secondary">Cancel</a><button type="submit" class="btn btn-outline-success">Save</button></section>
</form>
@endsection
