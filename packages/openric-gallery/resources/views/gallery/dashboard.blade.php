...
<div class="row">
  <div class="col-md-4 mb-3"><a href="{{ route('gallery.artwork.browse') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-images me-1"></i>Browse Gallery</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery.artwork.create') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-plus me-1"></i>Add Artwork</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery.artists') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-user me-1"></i>Artists</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery.loans') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-exchange-alt me-1"></i>Loans</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery.valuations') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-coins me-1"></i>Valuations</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery.venues') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-building me-1"></i>Venues</a></div>
</div>
@if(isset($recentItems) && count($recentItems) > 0)
<div class="card mt-3">
  <div class="card-header bg-dark text-white"><h5 class="mb-0">Recently Added</h5></div>
  <div class="card-body p-0">
    <table class="table table-striped mb-0"><thead><tr class="table-dark"><th>Title</th><th>Artist</th><th>Date</th></tr></thead>
