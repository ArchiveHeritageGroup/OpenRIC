...
@section('content')
<div class="card"><div class="card-header bg-dark text-white"><h5 class="mb-0">Venue Details</h5></div>
...
<div class="mt-3"><a href="{{ route('gallery.venues') }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back to Venues</a></div>
@endsection
