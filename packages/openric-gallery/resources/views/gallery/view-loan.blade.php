...
@section('content')
<div class="card"><div class="card-header bg-dark text-white"><h5 class="mb-0">Loan Details</h5></div>
...
<div class="mt-3"><a href="{{ route('gallery.loans') }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back to Loans</a></div>
@endsection
