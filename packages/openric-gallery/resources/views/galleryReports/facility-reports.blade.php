...
@section('content')
<div class="card">
  <div class="card-header bg-dark text-white"><h5 class="mb-0">Facility Reports</h5></div>
  <div class="card-body p-0">
    @if(isset($items) && count($items) > 0)
      <table class="table table-striped table-hover mb-0">
        <thead><tr class="table-dark"><th>Name</th><th>Type</th><th>Date</th><th>Status</th></tr></thead>
        <tbody>
...
<div class="mt-3"><a href="{{ route('gallery-reports.index') }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back to Reports Dashboard</a></div>
@endsection
