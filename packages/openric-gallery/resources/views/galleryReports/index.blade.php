...
<div class="row mb-4">
  ...
  </div><div class="text-end mt-2"><a href="{{ route('gallery-reports.exhibitions') }}" class="btn btn-sm btn-outline-secondary">View Report</a></div></div></div></div>
</div>
<div class="row mb-4">
  <div class="col-md-6"><div class="card h-100"><div class="card-header bg-dark text-white"><h5 class="mb-0">Loans</h5></div>
  ...
  <div class="text-end mt-2"><a href="{{ route('gallery-reports.loans') }}" class="btn btn-sm btn-outline-secondary">View Report</a></div></div></div></div>
  <div class="col-md-6"><div class="card h-100"><div class="card-header bg-dark text-white"><h5 class="mb-0">Valuations</h5></div>
  ...
  <div class="text-end mt-2"><a href="{{ route('gallery-reports.valuations') }}" class="btn btn-sm btn-outline-secondary">View Report</a></div></div></div></div>
</div>
<div class="row">
  <div class="col-md-4 mb-3"><a href="{{ route('gallery-reports.exhibitions') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-images me-1"></i>Exhibitions</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery-reports.loans') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-exchange-alt me-1"></i>Loans</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery-reports.valuations') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-coins me-1"></i>Valuations</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery-reports.facility-reports') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-building me-1"></i>Facility Reports</a></div>
  <div class="col-md-4 mb-3"><a href="{{ route('gallery-reports.spaces') }}" class="btn btn-outline-secondary w-100"><i class="fas fa-th-large me-1"></i>Spaces</a></div>
</div>
@endsection
