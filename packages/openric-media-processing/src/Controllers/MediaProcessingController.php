...
namespace OpenRicMediaProcessing\Controllers;
...
class MediaProcessingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('openric-media-processing::index', compact(
            'stats',
            'recentDerivatives',
            'missingDerivatives',
            'usageLabels'
    ...
    public function watermarkSettings(Request $request)
    {
        ...
        return view('openric-media-processing::watermark-settings', compact(
            'settings',
            'watermarkTypes',
            'customWatermarks',
            'positions'
