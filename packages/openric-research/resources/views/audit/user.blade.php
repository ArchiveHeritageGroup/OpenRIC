{{-- Audit User Activity - Adapted from Heratio: audit/userSuccess.php --}}
...
<div class="mt-3"><a href="{{ route('audit.index') }}" class="btn btn-outline-primary"><i class="fas fa-arrow-left me-1"></i>Back</a></div>
@endsection
