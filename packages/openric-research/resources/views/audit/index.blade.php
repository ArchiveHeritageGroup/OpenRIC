{{-- Audit Trail Index - Adapted from Heratio: audit/indexSuccess.php --}}
  ...
  <div class="card-body">
    <form method="get" class="row g-3">
      ...
      <div class="col-md-2 d-flex align-items-end">
        <button type="submit" class="btn btn-outline-primary btn-sm me-2"><i class="fas fa-search"></i> Filter</button>
...
<div class="mt-3">
  <a href="{{ route('settings.index') }}" class="btn btn-outline-primary"><i class="fas fa-arrow-left me-1"></i>Back to Settings</a>
</div>
@endsection
