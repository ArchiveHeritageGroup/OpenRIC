{{-- Audit Record History - Adapted from Heratio: audit/recordSuccess.php --}}
...
@else
  ...
  @endforeach
@endif
<a href="{{ route('audit.index') }}" class="btn btn-outline-primary"><i class="fas fa-arrow-left me-1"></i>Back</a>
@endsection
