{{-- Audit Entry Detail - Adapted from Heratio: audit/viewSuccess.php --}}
...
<a href="{{ route('audit.index') }}" class="btn btn-outline-primary"><i class="fas fa-arrow-left me-1"></i>Back to Audit Log</a>
@endsection
