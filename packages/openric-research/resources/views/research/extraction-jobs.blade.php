{{-- Extraction Jobs - Adapted from Heratio --}}
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#newJobModal"><i class="fas fa-plus me-1"></i>New Job</button>
</div>
@if(!empty($jobs))
<div class="card">
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><div class="progress" style="height:6px;"><div class="progress-bar" style="width:{{ $job->progress ?? 0 }}%"></div></div><small>{{ $job->progress ?? 0 }}%</small></td>
...
<div class="modal fade" id="newJobModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><form method="POST">@csrf
    ...
    <div class="modal-footer"><button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-outline-primary">Start Job</button></div>
</form></div></div></div>
    </div>
</div>
@endsection
