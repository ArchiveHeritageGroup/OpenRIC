{{-- Custody Return Verify - Adapted from Heratio --}}
    ...
    <div class="card-body">
        <form method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4"><label class="form-label">Return Condition <span class="badge bg-danger ms-1">Required</span></label>
            ...
            <div class="mb-3"><label class="form-label">Return Notes <span class="badge bg-secondary ms-1">Optional</span></label><textarea name="return_notes" class="form-control" rows="2"></textarea></div>
            ...
            <button type="submit" class="btn btn-outline-primary"><i class="fas fa-check-double me-1"></i>Verify Return</button>
