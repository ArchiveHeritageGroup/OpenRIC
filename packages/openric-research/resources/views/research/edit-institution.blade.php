{{-- Edit Institution - Adapted from Heratio --}}
@extends('theme::layouts.1col')
@section('title', ($isNew ?? true) ? 'Add Institution' : 'Edit Institution')
@section('content')
<div class="d-flex">
    @include('research::research._sidebar', ['sidebarActive' => 'institutions'])
...
<div class="card">
    <div class="card-body">
        <form method="POST">
            @csrf
            <div class="row mb-3">
                <div class="col-md-8"><label class="form-label">Name <span class="badge bg-danger ms-1">Required</span></label><input type="text" name="name" class="form-control" required value="{{ e($institution->name ?? '') }}"></div>
            ...
            <a href="{{ route('research.institutions') }}" class="btn btn-outline-secondary">Cancel</a>
        </form>
    </div>
</div>
    </div>
