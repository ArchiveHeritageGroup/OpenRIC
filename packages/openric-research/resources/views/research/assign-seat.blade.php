{{-- Assign Seat - Adapted from Heratio --}}
...
<nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="{{ route('research.dashboard') }}">Research</a></li><li class="breadcrumb-item"><a href="{{ route('research.seats') }}">Seats</a></li><li class="breadcrumb-item active">Assign Seat</li></ol></nav>
...
<div class="row">
    <div class="col-md-6">
        <div class="card mb-4">
            <div class="card-header bg-primary text-white"><i class="fas fa-user me-2"></i>Researcher</div>
            <div class="card-body">
                <dl class="row mb-0">
    ...
    <div class="col-md-6">
        <div class="card mb-4">
            <div class="card-header bg-primary text-white"><i class="fas fa-chair me-2"></i>Available Seats</div>
            <div class="card-body">
                <form method="POST">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-outline-primary"><i class="fas fa-check me-1"></i>Assign Seat</button>
                    <a href="{{ route('research.seats') }}" class="btn btn-outline-secondary">Cancel</a>
                </form>
            </div>
        </div>
    </div>
