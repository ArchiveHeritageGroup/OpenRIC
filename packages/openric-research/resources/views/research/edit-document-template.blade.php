{{-- Edit Document Template - Adapted from Heratio --}}
...
<div class="card">
    <div class="card-body">
        <form method="POST">
            @csrf
            <div class="row mb-3">
                <div class="col-md-8"><label class="form-label">Template Name <span class="badge bg-danger ms-1">Required</span></label><input type="text" name="name" class="form-control" required value="{{ e($template->name ?? '') }}"></div>
            ...
            <div class="mb-3"><label class="form-label">Description <span class="badge bg-secondary ms-1">Optional</span></label><textarea name="description" class="form-control" rows="2">{{ e($template->description ?? '') }}</textarea></div>
            <div class="mb-3"><label class="form-label">Template Content <span class="badge bg-danger ms-1">Required</span></label><textarea name="content" class="form-control font-monospace" rows="15" required>{{ e($template->content ?? '') }}</textarea>
            ...
            <button type="submit" class="btn btn-outline-primary"><i class="fas fa-save me-1"></i>Save Template</button>
            <a href="{{ route('research.documentTemplates') }}" class="btn btn-outline-secondary">Cancel</a>
        </form>
    </div>
</div>
    </div>
