{{-- Invite Collaborator - Adapted from Heratio --}}
...
<div class="card"><div class="card-body">
    <form method="POST">@csrf
        ...
        <div class="mb-3"><label class="form-label">Email Address <span class="badge bg-danger ms-1">Required</span></label><input type="email" name="email" class="form-control" required placeholder="researcher@example.com"></div>
        ...
        <button type="submit" class="btn btn-outline-primary"><i class="fas fa-paper-plane me-1"></i>Send Invitation</button>
        <a href="{{ route('research.viewProject', $project->id ?? 0) }}" class="btn btn-outline-secondary">Cancel</a>
    </form>
</div></div>
