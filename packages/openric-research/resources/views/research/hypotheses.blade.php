{{-- Hypotheses - Adapted from Heratio --}}
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addHypothesisModal"><i class="fas fa-plus me-1"></i>New Hypothesis</button>
</div>
@if(!empty($hypotheses))
<div class="row">
...
<div class="modal fade" id="addHypothesisModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><form method="POST">@csrf <input type="hidden" name="project_id" value="{{ $project->id ?? 0 }}">
    ...
    <div class="modal-footer"><button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button><button type="submit" class="btn btn-outline-primary">Create</button></div>
</form></div></div></div>
    </div>
</div>
@endsection
