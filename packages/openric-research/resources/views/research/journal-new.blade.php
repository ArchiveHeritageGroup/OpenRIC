{{-- New Journal Entry - Adapted from Heratio --}}
@extends('theme::layouts.1col')
@section('title', 'New Journal Entry')
@section('content')
<div class="d-flex">
    @include('research::research._sidebar', ['sidebarActive' => 'journal'])
...
<div class="card-body">
    <form method="POST" id="entryForm">@csrf <input type="hidden" name="content" id="entryContentHidden" value="">
        ...
        <button type="submit" class="btn btn-outline-primary"><i class="fas fa-save me-1"></i>Save Entry</button>
        <a href="{{ route('research.journal') }}" class="btn btn-outline-secondary">Cancel</a>
    </form>
</div></div>
