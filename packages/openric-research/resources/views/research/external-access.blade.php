{{-- External Access - Adapted from Heratio --}}
...
<div class="row">
    <div class="col-md-8">
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">Shared Links</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST">@csrf
                    ...
                    <button type="submit" class="btn btn-outline-primary w-100"><i class="fas fa-link me-1"></i>Create Link</button>
                </form>
            </div>
        </div>
    </div>
