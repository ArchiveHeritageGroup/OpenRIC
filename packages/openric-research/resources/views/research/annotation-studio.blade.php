{{-- Annotation Studio - Adapted from Heratio --}}
    ...
    <div class="col-md-8">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-outline-primary" id="addAnnotationBtn"><i class="fas fa-plus me-1"></i>Add Annotation</button>
            </div>
            <div class="card-body p-0">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('research.annotations.store') }}">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm" id="cancelAnnotation">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-primary" id="importIiifBtn"><i class="fas fa-file-import me-1"></i>Import</button>
            </div>
        </div>
    </div>
</div>
