...
namespace OpenRic\Ipsas\Controllers;

use OpenRic\Ipsas\Services\IpsasService;
...
class IpsasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('openric-ipsas::index', compact('stats', 'compliance', 'config', 'recentAssets', 'expiringInsurance'));
    }
    ...
    public function assets(Request $request)
    {
        ...
        return view('openric-ipsas::assets', compact('assets', 'categories', 'filters'));
    }
    ...
    public function assetCreate(Request $request)
    {
        ...
        return view('openric-ipsas::asset-create', compact('categories'));
    }
    ...
    public function assetView(int $id)
    {
        ...
        return view('openric-ipsas::asset-view', compact('asset', 'valuations', 'impairments'));
    }
    ...
    public function assetEdit(Request $request, int $id)
    {
        ...
        return view('openric-ipsas::asset-edit', compact('asset', 'categories'));
    }
    ...
    public function valuations(Request $request)
    {
        ...
        return view('openric-ipsas::valuations', compact('valuations', 'filters'));
    }
    ...
    public function valuationCreate(Request $request)
    {
        ...
        return view('openric-ipsas::valuation-create', compact('asset'));
    }
    ...
    public function impairments(Request $request)
    {
        ...
        return view('openric-ipsas::impairments', compact('impairments'));
    }
    ...
    public function insurance(Request $request)
    {
        ...
        return view('openric-ipsas::insurance', compact('policies', 'currentStatus'));
    }
    ...
    public function reports(Request $request)
    {
        ...
        return view('openric-ipsas::reports', compact('year'));
    }
    ...
    public function financialYear(Request $request)
    {
        ...
        return view('openric-ipsas::financial-year', compact('year', 'summary'));
    }
    ...
    public function config(Request $request)
    {
        ...
        return view('openric-ipsas::config', compact('config'));
    }
    ...
    public function admin()
    {
        ...
        return view('openric-ipsas::admin', compact('config', 'stats'));
    }
