...
class PlaceController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('places.show', ['iri' => urlencode($iri)])->with('success', 'Place created.');
    }
    ...
    public function edit(string $iri): View
    {
        ...
        return view('place-manage::places.edit', ['entity' => $entity]);
    }
    ...
    public function update(Request $request, string $iri): RedirectResponse
    {
        ...
        return redirect()->route('places.show', ['iri' => urlencode($iri)])->with('success', 'Place updated.');
    }
