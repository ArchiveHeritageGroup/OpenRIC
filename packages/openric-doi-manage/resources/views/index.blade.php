...
@section('content')
  @if(!($tablesExist ?? false))
    <div class="alert alert-warning">
      ...
      The DOI management tables (<code>dois</code>, <code>doi_queue</code>, <code>doi_log</code>) have not been created yet.
  ...
  @else
    ...
    <div class="multiline-header d-flex align-items-center mb-3">
      ...
      <div class="d-flex gap-2">
        <div class="btn-group">
          <a href="{{ route('doi.report') }}?format=csv" class="btn btn-sm btn-outline-secondary" title="Export CSV">
        ...
        <a href="{{ route('doi.config') }}" class="btn btn-sm btn-outline-secondary">
    ...
    @if(count($recentDois))
      ...
      <div class="text-end">
        <a href="{{ route('doi.browse') }}" class="btn btn-sm btn-outline-secondary">View All DOIs</a>
      </div>
    @else
      <div class="text-center text-muted py-4">
        <i class="fas fa-link fa-3x mb-3"></i>
        <p>No DOIs minted yet.</p>
        <a href="{{ route('doi.batch-mint') }}" class="btn btn-outline-secondary">Mint Your First DOI</a>
      </div>
    @endif
  @endif
@endsection
