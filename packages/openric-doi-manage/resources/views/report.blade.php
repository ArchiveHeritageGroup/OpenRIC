  ...
  @else
    <div class="multiline-header d-flex align-items-center mb-3">
      ...
      <div class="d-flex gap-2">
        ...
        <div class="btn-group">
          <a href="{{ route('doi.report') }}?format=csv" class="btn btn-sm btn-outline-secondary">
            <i class="fas fa-file-csv me-1"></i> Export CSV
          </a>
          <a href="{{ route('doi.report') }}?format=json" class="btn btn-sm btn-outline-secondary">
              ...
              <table class="table table-sm mb-0">
                ...
                <tbody>
                  ...
                  @foreach($byRepository as $row)
                    ...
                    @endphp
                    <tr>
                      <td>{{ $row['repository_name'] ?: '[Unknown]' }}</td>
