...
class MultiTenantController extends Controller
{
    ...
    {
        return view('openric-multi-tenant::admin');
    }
    ...
    public function branding(Request $request)
    {
        ...
        return view('openric-multi-tenant::branding', compact('tenantId'));
    }
    ...
    public function users(Request $request)
    {
        ...
        return view('openric-multi-tenant::users', compact('tenantId'));
    }
}
