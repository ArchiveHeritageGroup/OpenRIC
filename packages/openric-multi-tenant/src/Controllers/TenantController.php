...
namespace OpenRicMultiTenant\Controllers;

use OpenRicMultiTenant\Services\TenantService;
...
class TenantController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('openric-multi-tenant::index', compact('tenants'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('openric-multi-tenant::create');
    }
    ...
    public function edit(Request $request, int $id)
    {
        ...
        return view('openric-multi-tenant::edit-tenant', compact('tenant'));
    }
    ...
    public function superUsers()
    {
        ...
        return view('openric-multi-tenant::super-users', compact('users'));
    }
    ...
    public function users(int $tenantId)
    {
        ...
        return view('openric-multi-tenant::users', compact('tenant', 'users'));
    }
    ...
    public function branding(Request $request, int $tenantId)
    {
        ...
        return view('openric-multi-tenant::branding', compact('tenant', 'branding'));
    }

    public function unknownDomain()
    {
        return view('openric-multi-tenant::unknown-domain');
    }

    public function unknownTenant()
    {
        return view('openric-multi-tenant::unknown-tenant');
    }
    ...
    public function admin()
    {
        ...
        return view('openric-multi-tenant::admin', compact('tenants', 'stats'));
    }
