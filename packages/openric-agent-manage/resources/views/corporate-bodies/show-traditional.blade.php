...
@section('title', $isaar['5.1.2']['value'] ?? 'Corporate Body')
...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3 mb-0">
            {{ $isaar['5.1.2']['value'] ?? 'Corporate Body' }}
            <span class="badge bg-success">Corporate Body</span>
        </h1>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <dl class="row mb-0">
                ...
                <dd class="col-sm-8">Corporate Body</dd>
