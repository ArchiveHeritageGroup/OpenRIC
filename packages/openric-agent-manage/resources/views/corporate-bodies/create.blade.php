...
@section('title', 'Create CorporateBody')
@section('content')
<h1 class="h3 mb-4">Create CorporateBody</h1>
@include('theme::partials.alerts')
<form method="POST" action="{{ route('corporate-bodies.store') }}">@csrf
    ...
    <div class="mt-3"><button type="submit" class="btn btn-primary">Create CorporateBody</button> <a href="{{ route('corporate-bodies.index') }}" class="btn btn-secondary">Cancel</a></div>
</form>
@endsection