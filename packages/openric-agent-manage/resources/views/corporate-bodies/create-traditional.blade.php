...
@section('content')
  ...
  <form method="POST" action="{{ route('corporate-bodies.store') }}" id="isaarForm">
    @csrf
    <input type="hidden" name="_form_type" value="isaar_cpf">
    <input type="hidden" name="entity_type" value="corporate_body">
          ...
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <select name="entity_type_id" id="entity_type_id" class="form-select @error('entity_type_id') is-invalid @enderror" required>
                ...
                <option value="corporate_body" {{ old('entity_type_id', 'corporate_body') === 'corporate_body' ? 'selected' : '' }}>Corporate body</option>
    ...
    <div class="mt-3 mb-5">
      ...
      <a href="{{ route('corporate-bodies.index') }}" class="btn btn-secondary ms-2">Cancel</a>
    </div>
  </form>
