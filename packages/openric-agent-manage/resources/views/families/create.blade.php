...
@section('content')
<h1 class="h3 mb-4">Create Family</h1>
@include('theme::partials.alerts')
<form method="POST" action="{{ route('families.store') }}">@csrf
    ...
    <div class="mt-3"><button type="submit" class="btn btn-primary">Create Family</button> <a href="{{ route('families.index') }}" class="btn btn-secondary">Cancel</a></div>
</form>
@endsection