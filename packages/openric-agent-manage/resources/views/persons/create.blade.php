...
@section('content')
<h1 class="h3 mb-4">Create Person</h1>
@include('theme::partials.alerts')
<form method="POST" action="{{ route('persons.store') }}">@csrf
    ...
    <div class="mt-3"><button type="submit" class="btn btn-primary">Create Person</button> <a href="{{ route('persons.index') }}" class="btn btn-secondary">Cancel</a></div>
</form>
@endsection