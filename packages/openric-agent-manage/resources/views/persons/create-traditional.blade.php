...
@section('title', 'Create Person — ISAAR-CPF')

@section('content')
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Create Person <span class="badge bg-secondary">ISAAR-CPF</span></h1>
    @include('theme::partials.view-switch')
  </div>

  @include('theme::partials.alerts')

  <form method="POST" action="{{ route('persons.store') }}" id="isaarForm">
    @csrf
          ...
          <div class="accordion-body">
            ...
            <div class="mb-3">
              ...
              <select name="entity_type_id" id="entity_type_id" class="form-select @error('entity_type_id') is-invalid @enderror" required>
                ...
                <option value="family" {{ old('entity_type_id') === 'family' ? 'selected' : '' }}>Family</option>
                <option value="person" {{ old('entity_type_id', 'person') === 'person' ? 'selected' : '' }}>Person</option>
              </select>
    ...
    <div class="mt-3 mb-5">
      ...
      <a href="{{ route('persons.index') }}" class="btn btn-secondary ms-2">Cancel</a>
    </div>
  </form>
