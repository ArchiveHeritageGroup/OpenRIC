...
namespace OpenRic\Federation\Controllers;

use OpenRic\Federation\Services\FederationService;
...
class FederationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('federation::index', compact('stats', 'peers'));
    }
    ...
    public function peers()
    {
        ...
        return view('federation::peers', compact('peers'));
    }
    ...
    public function editPeer(Request $request, ?int $id = null)
    {
        ...
        return view('federation::edit-peer', compact('peer', 'isNew'));
    }
    ...
    public function harvest(Request $request)
    {
        ...
        return view('federation::harvest', compact('peers'));
    }
    ...
    public function log(Request $request)
    {
        ...
        return view('federation::log', compact('logs', 'peers', 'peerId'));
    }
