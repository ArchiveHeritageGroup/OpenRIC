...
class InstantiationController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('instantiations.show', ['iri' => urlencode($iri)])->with('success', 'Instantiation created.');
    }
    ...
    public function edit(string $iri): View
    {
        ...
        return view('instantiation-manage::instantiations.edit', ['entity' => $entity]);
    }
    ...
    public function update(Request $request, string $iri): RedirectResponse
    {
        ...
        return redirect()->route('instantiations.show', ['iri' => urlencode($iri)])->with('success', 'Instantiation updated.');
    }
    ...
    public function destroy(string $iri): RedirectResponse
    {
        ...
        return redirect()->route('instantiations.index')->with('success', 'Instantiation deleted.');
    }
}
