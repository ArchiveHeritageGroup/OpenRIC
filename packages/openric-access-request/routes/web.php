...
use OpenRic\AccessRequest\Controllers\AccessRequestController;
...
Route::middleware('auth')->prefix('access-request')->group(function () {
    ...
    Route::get('/{id}', [AccessRequestController::class, 'view'])->name('accessRequest.view')->where('id', '[a-zA-Z0-9\-]+');
});

Route::middleware(['auth', 'admin'])->prefix('access-request')->group(function () {
    Route::get('/pending', [AccessRequestController::class, 'pending'])->name('accessRequest.pending');
    Route::post('/{id}/approve', [AccessRequestController::class, 'approve'])->name('accessRequest.approve')->where('id', '[a-zA-Z0-9\-]+');
    Route::post('/{id}/deny', [AccessRequestController::class, 'deny'])->name('accessRequest.deny')->where('id', '[a-zA-Z0-9\-]+');
    ...
    Route::delete('/approvers/{id}', [AccessRequestController::class, 'removeApprover'])->name('accessRequest.removeApprover')->where('id', '[a-zA-Z0-9\-]+');
});

Route::middleware('auth')->prefix('access-request')->group(function () {
    Route::post('/{id}/cancel', [AccessRequestController::class, 'cancel'])->name('accessRequest.cancel')->where('id', '[a-zA-Z0-9\-]+');
...
Route::post('/security/request/{id}/cancel', [AccessRequestController::class, 'cancel'])->middleware('auth')->name('accessRequest.legacyCancel')->where('id', '[a-zA-Z0-9\-]+');
Route::get('/security/request/{id}', [AccessRequestController::class, 'view'])->middleware('auth')->name('accessRequest.legacyView')->where('id', '[a-zA-Z0-9\-]+');
Route::post('/security/request/{id}/approve', [AccessRequestController::class, 'approve'])->middleware('admin')->name('accessRequest.legacyApprove')->where('id', '[a-zA-Z0-9\-]+');
Route::post('/security/request/{id}/deny', [AccessRequestController::class, 'deny'])->middleware('admin')->name('accessRequest.legacyDeny')->where('id', '[a-zA-Z0-9\-]+');
Route::get('/security/request/{id}/review', [AccessRequestController::class, 'view'])->middleware('admin')->name('accessRequest.legacyReview')->where('id', '[a-zA-Z0-9\-]+');
...
Route::post('/security/approvers/{id}/remove', [AccessRequestController::class, 'removeApprover'])->middleware('admin')->name('accessRequest.legacyRemoveApprover')->where('id', '[a-zA-Z0-9\-]+');
