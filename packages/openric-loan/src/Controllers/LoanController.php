...
namespace OpenRicLoan\Controllers;
...
class LoanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('openric-loan::loan.index', compact('loans', 'stats', 'params'));
    }
    ...
    public function show(int $id)
    {
        ...
        return view('openric-loan::loan.show', compact('loan', 'validTransitions'));
    }
    ...
    {
        return view('openric-loan::loan.create');
    }
    ...
    public function edit(Request $request, int $id)
    {
        ...
        return view('openric-loan::loan.edit', compact('loan'));
    }
    ...
    public function dashboard() { return view('openric-loan::loan-dashboard', ['activeCount'=>0,'overdueCount'=>0,'returningCount'=>0,'completedCount'=>0]); }
}
