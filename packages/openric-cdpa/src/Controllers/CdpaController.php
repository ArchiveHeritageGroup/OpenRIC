...
namespace OpenRicCdpa\Controllers;
...
class CdpaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('openric-cdpa::index', compact('stats', 'recentAudit'));
    }
    ...
    public function config(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.config')
        ...
        return view('openric-cdpa::config', compact('settings'));
    }
    ...
    public function dpo()
    {
        ...
        return view('openric-cdpa::dpo', compact('dpos'));
    }
    ...
    public function dpoEdit(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.dpo')->with('success', $message);
        }

        return view('openric-cdpa::dpo-edit', compact('dpo'));
    }
    ...
    public function processing(Request $request)
    {
        ...
        return view('openric-cdpa::processing', compact('activities', 'categories'));
    }
    ...
    public function processingCreate(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.processing')
                ->with('success', 'Processing activity created.');
        }

        return view('openric-cdpa::processing-create');
    }
    ...
    public function processingEdit(Request $request)
    {
        ...
        return view('openric-cdpa::processing-edit', compact('activity'));
    }
    ...
    public function consent(Request $request)
    {
        ...
        return view('openric-cdpa::consent', compact('consents'));
    }
    ...
    public function requests(Request $request)
    {
        ...
        return view('openric-cdpa::requests', compact('requests', 'statuses', 'types'));
    }
    ...
    public function requestCreate(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.requests')
                ->with('success', 'Data subject request created. Ref: ' . $validated['reference_number']);
        }

        return view('openric-cdpa::request-create');
    }
    ...
    public function requestView(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.request-view', ['id' => $id])
        ...
        return view('openric-cdpa::request-view', compact('dsr', 'auditTrail'));
    }
    ...
    public function dpia(Request $request)
    {
        ...
        return view('openric-cdpa::dpia', compact('dpias', 'statuses'));
    }
    ...
    public function dpiaCreate(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.dpia')
        ...
        return view('openric-cdpa::dpia-create', compact('activities'));
    }
    ...
    public function dpiaView(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.dpia-view', ['id' => $id])
        ...
        return view('openric-cdpa::dpia-view', compact('dpia', 'auditTrail'));
    }
    ...
    public function breaches(Request $request)
    {
        ...
        return view('openric-cdpa::breaches', compact('breaches', 'statuses'));
    }
    ...
    public function breachCreate(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.breaches')
                ->with('success', 'Breach reported. Ref: ' . $validated['reference_number']);
        }

        return view('openric-cdpa::breach-create');
    }
    ...
    public function breachView(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.breach-view', ['id' => $id])
        ...
        return view('openric-cdpa::breach-view', compact('breach', 'auditTrail'));
    }
    ...
    public function license()
    {
        ...
        return view('openric-cdpa::license', compact('licenses'));
    }
    ...
    public function licenseEdit(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('openriccdpa.license')->with('success', $message);
        }

        return view('openric-cdpa::license-edit', compact('license'));
    }
    ...
    public function reports(Request $request)
    {
        ...
        return view('openric-cdpa::reports', compact(
            'dateFrom', 'dateTo',
