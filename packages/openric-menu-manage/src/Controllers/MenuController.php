...
namespace OpenRicMenuManage\Controllers;

use OpenRicMenuManage\Services\MenuService;
...
class MenuController extends Controller
{
    ...
    public function browse()
    {
        ...
        return view('openric-menu-manage::browse', [
            'tree' => $tree,
            'total' => count($tree),
        ]);
    }
    ...
    public function show(int $id)
    {
        ...
        return view('openric-menu-manage::show', [
            'menu' => (object) $menu,
            'children' => $children,
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('openric-menu-manage::edit', [
            'menu' => null,
    ...
    public function confirmDelete(int $id)
    {
        ...
        return view('openric-menu-manage::delete', [
            'menu' => (object) $menu,
        ]);
    }
