...
class EmbargoController extends Controller
{
    public function index()
    {
        ...
        return view('openric-rights-holder-manage::embargo.index', compact('activeEmbargoes', 'expiringEmbargoes'));
    }
    ...
    public function create(int $objectId)
    {
        ...
        return view('openric-rights-holder-manage::embargo.add', compact('resource', 'objectId', 'descendantCount'));
    }
    ...
    public function show(int $id)
    {
        ...
        return view('openric-rights-holder-manage::embargo.view', compact('embargo'));
    }
    ...
    public function liftForm(int $id)
    {
        ...
        return view('openric-rights-holder-manage::embargo.lift', compact('embargo', 'resource'));
    }
