...
class RightsAdminController extends Controller
{
    public function index()
    {
        ...
        return view('openric-rights-holder-manage::rightsAdmin.index', compact('stats'));
    }
    ...
    public function embargoes()
    {
        ...
        return view('openric-rights-holder-manage::rightsAdmin.embargoes', compact('embargoes'));
    }
    ...
    public function embargoEdit(int $id)
    {
        ...
        return view('openric-rights-holder-manage::rightsAdmin.embargo-edit', compact('embargo'));
    }
    ...
    public function orphanWorks()
    {
        ...
        return view('openric-rights-holder-manage::rightsAdmin.orphan-works', compact('orphanWorks'));
    }
    ...
    public function orphanWorkEdit(int $id)
    {
        ...
        return view('openric-rights-holder-manage::rightsAdmin.orphan-work-edit', compact('orphanWork'));
    }
    ...
    public function report()
    {
        ...
        return view('openric-rights-holder-manage::rightsAdmin.report', compact('stats', 'byBasis', 'byHolder'));
    }

    public function statements()
    {
        $statements = Schema::hasTable('rights_statement') ? DB::table('rights_statement')->orderBy('sort_order')->get() : collect();
        return view('openric-rights-holder-manage::rightsAdmin.statements', compact('statements'));
    }

    public function tkLabels()
    {
        $tkLabels = Schema::hasTable('tk_label') ? DB::table('tk_label')->orderBy('sort_order')->get() : collect();
        return view('openric-rights-holder-manage::rightsAdmin.tk-labels', compact('tkLabels'));
    }
}
