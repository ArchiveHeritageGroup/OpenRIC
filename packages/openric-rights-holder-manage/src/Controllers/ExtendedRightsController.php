...
namespace OpenRic\RightsHolderManage\Controllers;
...
class ExtendedRightsController extends Controller
{
    public function index()
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.index', compact('rightsStatements', 'ccLicenses', 'tkLabels', 'stats'));
    }

    public function dashboard()
    {
        $stats = $this->getStats();
        return view('openric-rights-holder-manage::extendedRights.dashboard', compact('stats'));
    }
    ...
    public function view(string $slug)
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.view', compact('rightsData', 'resource'));
    }
    ...
    public function batch()
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.batch', compact('topLevelRecords', 'rightsStatements', 'ccLicenses', 'tkLabels', 'donors'));
    }
    ...
    public function clear(string $slug)
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.clear', compact('resource', 'currentRights'));
    }
    ...
    public function embargoBlocked()
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.embargo-blocked', compact('embargoInfo'));
    }
    ...
    public function embargoStatus(Request $request)
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.embargo-status', compact('objectId', 'embargo'));
    }
    ...
    public function embargoes()
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.embargoes', compact('embargoes'));
    }
    ...
    public function expiringEmbargoes(Request $request)
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.expiring-embargoes', compact('embargoes', 'days'));
    }
    ...
    public function export(Request $request)
    {
        ...
        return view('openric-rights-holder-manage::extendedRights.export', compact('topLevelRecords', 'stats'));
    }
