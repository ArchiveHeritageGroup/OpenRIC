...
use OpenRic\RightsHolderManage\Services\RightsHolderBrowseService;
use OpenRic\RightsHolderManage\Services\RightsHolderService;
...
class RightsHolderController extends Controller
{
    ...
    public function browse(Request $request)
    {
        ...
        return view('openric-rights-holder-manage::browse', [
    ...
    public function show(string $slug)
    {
        ...
        return view('openric-rights-holder-manage::show', [
            'rightsHolder' => $rh,
            'rights' => $rights,
    ...
    {
        return view('openric-rights-holder-manage::edit', [
            'rightsHolder' => null,
            'contacts' => collect(),
        ]);
    }
    ...
    public function confirmDelete(string $slug)
    {
        $rh = $this->service->getBySlug($slug);
        if (!$rh) abort(404);
        return view('openric-rights-holder-manage::delete', ['rightsHolder' => $rh]);
    }
