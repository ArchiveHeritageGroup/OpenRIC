...
@section('content')
  @include('openric-rights-holder-manage::show', ['rightsHolder' => $rightsHolder, 'contacts' => $contacts ?? collect(), 'rights' => $rights ?? collect(), 'basisNames' => $basisNames ?? [], 'extendedRights' => $extendedRights ?? collect(), 'extendedRightsTkLabels' => $extendedRightsTkLabels ?? []])
@endsection
