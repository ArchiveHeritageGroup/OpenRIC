...
namespace OpenRic\Icip\Controllers;
...
class IcipController extends Controller
{
    ...
    public function dashboard()
    {
        if (!Schema::hasTable('icip_community')) {
            return view('openric-icipdashboard', [
                'stats'                => [],
    ...
    {
        if (!Schema::hasTable('icip_community')) {
            return view('openric-icipcommunities', [
                'communities' => collect(),
    ...
    public function communityEdit(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($id) {
                ...
                return redirect()->route('icip.communities')->with('notice', 'Community updated successfully.');
            } else {
                $data['created_by'] = auth()->id();
                $data['created_at'] = now();
                DB::table('icip_community')->insert($data);
                return redirect()->route('icip.communities')->with('notice', 'Community created successfully.');
            }
        }

        return view('openric-icipcommunity-edit', [
            'id'        => $id,
            'community' => $community,
            'states'    => self::STATE_TERRITORIES,
        ]);
    ...
    public function communityView(Request $request)
    {
        ...
        return view('openric-icipcommunity-view', [
            'id'             => $id,
            'community'      => $community,
            'consents'       => $consents,
    ...
    public function communityDelete(Request $request)
    {
        ...
        if ($linkedConsents > 0 || $linkedNotices > 0) {
            return redirect()->route('icip.communities')
    ...
    public function consentList(Request $request)
    {
        if (!Schema::hasTable('icip_consent')) {
            return view('openric-icipconsent-list', [
                'consents'      => collect(),
    ...
    public function consentEdit(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($object) {
                return redirect()->route('icip.object-icip', ['slug' => $object->slug])
                    ->with('notice', 'Consent record saved successfully.');
            }
            return redirect()->route('icip.consent-list')
                ->with('notice', 'Consent record saved successfully.');
        }

        return view('openric-icipconsent-edit', [
            'id'            => $id,
            'consent'       => $consent,
            'object'        => $object,
            'objectId'      => $objectId,
    ...
    public function consentView(Request $request)
    {
        ...
        return view('openric-icipconsent-view', [
            'consent'       => $consent,
            'statusOptions' => self::CONSENT_STATUSES,
            'scopeOptions'  => self::CONSENT_SCOPES,
        ]);
    ...
    public function consultations(Request $request)
    {
        if (!Schema::hasTable('icip_consultation')) {
            return view('openric-icipconsultations', [
    ...
    public function consultationEdit(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('icip.consultations')
                ->with('notice', 'Consultation saved successfully.');
        }

        return view('openric-icipconsultation-edit', [
            'id'                    => $id,
    ...
    public function consultationView(Request $request)
    {
        ...
        return view('openric-icipconsultation-view', [
            'consultation'        => $consultation,
            'consultationTypes'   => self::CONSULTATION_TYPES,
            'consultationMethods' => self::CONSULTATION_METHODS,
            'consultationStatuses' => self::CONSULTATION_STATUSES,
    ...
    public function tkLabels()
    {
        if (!Schema::hasTable('icip_tk_label_type')) {
            return view('openric-iciptk-labels', [
                'labelTypes'    => collect(),
    ...
    public function notices()
    {
        if (!Schema::hasTable('icip_cultural_notice_type')) {
            return view('openric-icipnotices', [
                'noticeTypes'    => collect(),
    ...
    {
        if (!Schema::hasTable('icip_cultural_notice_type')) {
            return view('openric-icipnotice-types', [
                'noticeTypes' => collect(),
                'tablesExist' => false,
            ]);
        }
        ...
        if ($request->isMethod('post')) {
            ...
            if ($action === 'add') {
                ...
                return redirect()->route('icip.notice-types')
    ...
    public function restrictions()
    {
        if (!Schema::hasTable('icip_access_restriction')) {
            return view('openric-iciprestrictions', [
    ...
    {
        if (!Schema::hasTable('icip_consent')) {
            return view('openric-icipreports', [
                'stats'              => [],
    ...
    public function reportPending()
    {
        ...
        return view('openric-icipreport-pending', [
            'records'       => $records,
            'statusOptions' => self::CONSENT_STATUSES,
        ]);
    }
    ...
    public function reportExpiry(Request $request)
    {
        ...
        return view('openric-icipreport-expiry', [
            'days'    => $days,
            'records' => $records,
        ]);
    }
    ...
    public function reportCommunity(Request $request)
    {
        ...
        return view('openric-icipreport-community', [
            'community'      => $community,
            'consents'       => $consents,
            'consultations'  => $consultations,
            'notices'        => $notices,
    ...
    public function objectIcip(Request $request)
    {
        ...
        return view('openric-icipobject-icip', [
            'object'           => $object,
            'summary'          => $summary,
            'consents'         => $consents,
            'notices'          => $notices,
    ...
    public function objectConsent(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('icip.object-icip', ['slug' => $slug])
                ->with('notice', 'Consent record added.');
        }

        return view('openric-icipobject-consent', [
            'object'        => $object,
            'consents'      => $consents,
            'statusOptions' => self::CONSENT_STATUSES,
            'scopeOptions'  => self::CONSENT_SCOPES,
    ...
    public function objectNotices(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($action === 'add') {
                ...
                $this->updateObjectSummary($object->id);
                return redirect()->route('icip.object-notices', ['slug' => $slug])
        ...
        return view('openric-icipobject-notices', [
            'object'      => $object,
            'noticeTypes' => $noticeTypes,
            'communities' => $communities,
            'notices'     => $notices,
    ...
    public function objectLabels(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($action === 'add') {
                ...
                $this->updateObjectSummary($object->id);
                return redirect()->route('icip.object-labels', ['slug' => $slug])
        ...
        return view('openric-icipobject-labels', [
            'object'     => $object,
            'labelTypes' => $labelTypes,
            'communities' => $communities,
            'labels'     => $labels,
    ...
    public function objectRestrictions(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($action === 'add') {
                ...
                $this->updateObjectSummary($object->id);
                return redirect()->route('icip.object-restrictions', ['slug' => $slug])
        ...
        return view('openric-icipobject-restrictions', [
            'object'           => $object,
            'restrictionTypes' => self::RESTRICTION_TYPES,
            'communities'      => $communities,
            'restrictions'     => $restrictions,
    ...
    public function objectConsultations(Request $request)
    {
        ...
        return view('openric-icipobject-consultations', [
            'object'              => $object,
            'communities'         => $communities,
            'consultations'       => $consultations,
            'consultationTypes'   => self::CONSULTATION_TYPES,
