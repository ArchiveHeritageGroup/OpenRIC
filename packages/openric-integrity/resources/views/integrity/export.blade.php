...
@section('content')
<div class="d-flex align-items-center mb-3"><i class="fas fa-3x fa-shield-alt me-3"></i><div><h1 class="mb-0">Export</h1><span class="small text-muted">Export integrity data</span></div></div>
<div class="card"><div class="card-header"><h5 class="mb-0">Export Integrity Data</h5></div>
<div class="card-body">
