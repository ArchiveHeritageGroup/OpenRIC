...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Create Record <span class="badge bg-secondary">ISAD(G)</span></h1>
        @include('theme::partials.view-switch')
    </div>

    @include('theme::partials.alerts')

    <form method="POST" action="{{ route('records.store') }}" id="isadgForm">
        @csrf
            ...
            <div class="accordion-item">
                ...
                <div id="admin-collapse" class="accordion-collapse collapse" aria-labelledby="admin-heading">
                    <div class="accordion-body">
                        ...
                        {{-- Parent --}}
                        <div class="mb-3">
                            <label for="parent_iri" class="form-label">Parent (File/Series IRI) <span class="badge bg-secondary ms-1">Optional</span></label>
