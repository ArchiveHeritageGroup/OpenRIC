...
@section('title', 'Edit Record Part')

@section('content')
    <h1 class="h3 mb-4">Edit Record Part</h1>

    @include('theme::partials.alerts')

    <form method="POST" action="{{ route('record-parts.update', ['iri' => urlencode($entity['iri'])]) }}">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
        ...
        <div class="mt-3">
            ...
            <a href="{{ route('record-parts.show', ['iri' => urlencode($entity['iri'])]) }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
@endsection
