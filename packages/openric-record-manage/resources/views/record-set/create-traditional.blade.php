...
@section('content')
    ...
    <form method="POST" action="{{ route('record-sets.store') }}" id="isadgForm">
        @csrf
            ...
            <div class="accordion-item">
                ...
                <div id="admin-collapse" class="accordion-collapse collapse" aria-labelledby="admin-heading">
                    <div class="accordion-body">
                        ...
                        {{-- Parent record set --}}
                        <div class="mb-3">
                            <label for="parent_iri" class="form-label">Parent Record Set <span class="badge bg-secondary ms-1">Optional</span></label>
                            <input type="text" class="form-control" id="parent_iri" name="parent_iri"
                                   value="{{ old('parent_iri') }}" placeholder="IRI of parent record set">
                            <div class="form-text text-muted small">Enter the IRI of the parent record set if this description is part of a hierarchical arrangement.</div>
                        </div>
