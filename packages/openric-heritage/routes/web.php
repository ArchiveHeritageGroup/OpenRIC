...
use OpenRiC\Heritage\Controllers\HeritageAccountingController;
use OpenRiC\Heritage\Controllers\GrapComplianceController;
use OpenRiC\Heritage\Controllers\HeritageAdminController;
use OpenRiC\Heritage\Controllers\HeritageReportController;
...
Route::match(['get', 'post'], '/heritage/access/request/{slug}', [HeritageController::class, 'requestAccessBySlug'])->name('heritage.access-request');

// Contributor routes (auth required)
Route::middleware('auth')->group(function () {
    Route::match(['get', 'post'], '/heritage/contribute/{slug}', [HeritageController::class, 'contributeToItem'])->name('heritage.contribute-to-item');
    ...
    Route::post('/heritage/api/contribution/submit', [HeritageController::class, 'apiSubmitContribution'])->name('heritage.api.contribution-submit');
    ...
    Route::prefix('heritage/manage')->name('heritage.')->group(function () {
...
Route::match(['get', 'post'], '/heritage/register', [HeritageController::class, 'contributorRegister'])->name('heritage.contributor-register');
