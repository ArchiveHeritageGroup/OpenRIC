...
<div class="row">
      ...
      'extraFilters' => '
        <div class="mb-3">
          ...
          <select name="entityType" class="form-select form-select-sm">
            ...
            ($entityTypes ?? collect())->map(fn($t) => '<option value="' . $t->id . '"' . (($params['entityType'] ?? '') == $t->id ? ' selected' : '') . '>' . e($t->name) . '</option>')->implode('') .
          '</select>
        </div>',
    ])
  </div>
  <div class="col-md-9">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h1><i class="fas fa-user me-2"></i>Agent Report</h1>
      <div>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped table-sm">
        <thead>
          <tr><th>#</th><th>Name</th><th>Entity Type</th><th>Dates</th><th>Created</th><th>Updated</th></tr>
        </thead>
        <tbody>
