...
<div class="row">
  <div class="col-md-3">
    ...
    @include('reports::_filters', ['action' => route('reports.donors'), 'cultures' => $cultures ?? ['en']])
  </div>
  <div class="col-md-9">
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped table-sm">
        <thead><tr><th>#</th><th>Name</th><th>Email</th><th>Telephone</th><th>City</th><th>Created</th></tr></thead>
        <tbody>
