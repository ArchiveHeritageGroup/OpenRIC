      ...
      <div class="card-body p-0">
        <div class="table-responsive">
          <table class="table table-bordered table-sm table-striped mb-0">
            <thead>
              <tr>
                @foreach($columns ?? ['ID','Identifier','Title','Scope','Created','Updated'] as $col)
                  <th>{{ $col }}</th>
                @endforeach
              </tr>
            </thead>
            <tbody>
              ...
              @empty
              <tr><td colspan="{{ count($columns ?? ['ID','Identifier','Title','Scope','Created','Updated']) }}" class="text-center text-muted py-3">No results found</td></tr>
              @endforelse
            </tbody>
          </table>
        </div>
