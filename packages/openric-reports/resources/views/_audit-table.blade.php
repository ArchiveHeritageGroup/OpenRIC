{{-- Shared audit table partial. Expects $auditTitle, $records --}}
<div class="d-flex justify-content-between align-items-center mb-3">
  <h1><i class="fas fa-clipboard-check me-2"></i>{{ $auditTitle }}</h1>
  <a href="{{ route('reports.dashboard') }}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back</a>
</div>
  ...
  <div class="card-body p-0">
    <div class="table-responsive">
      <table class="table table-bordered table-sm table-striped mb-0">
        <thead>
          <tr>
            <th>Audit ID</th><th>User</th><th>Action</th><th>Date/Time</th><th>Record</th><th>Table</th><th>Details</th>
          </tr>
        </thead>
        <tbody>
