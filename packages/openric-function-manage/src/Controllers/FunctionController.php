...
namespace OpenRic\FunctionManage\Controllers;

use OpenRic\FunctionManage\Services\FunctionBrowseService;
use OpenRic\FunctionManage\Services\FunctionService;
use OpenRicCore\Pagination\SimplePager;
use OpenRicCore\Services\SettingHelper;
...
class FunctionController extends Controller
{
    ...
    public function browse(Request $request)
    {
        ...
        return view('openric-function-manage::browse', [
            'pager' => $pager,
    ...
    public function show(string $slug)
    {
        ...
        return view('openric-function-manage::show', [
            'function' => $function,
            'typeName' => $typeName,
    ...
    public function create()
    {
        ...
        return view('openric-function-manage::edit', [
            'function' => null,
    ...
    public function confirmDelete(string $slug)
    {
        ...
        return view('openric-function-manage::delete', [
            'function' => $function,
        ]);
    }
