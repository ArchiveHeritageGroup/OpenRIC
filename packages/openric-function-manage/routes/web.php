...
use OpenRic\FunctionManage\Controllers\FunctionController;
...
Route::match(['get','post'], '/autocomplete', function() { return view('openric-function-manage::autocomplete'); })->name('function.autocomplete');
});
