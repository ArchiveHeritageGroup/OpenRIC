...
@section('content')
  ...
  @php
    $canUpdate = \OpenRicCore\Services\AclService::check($function, 'update');
    $canDelete = \OpenRicCore\Services\AclService::check($function, 'delete');
    $canCreate = \OpenRicCore\Services\AclService::check($function, 'create');
  @endphp
