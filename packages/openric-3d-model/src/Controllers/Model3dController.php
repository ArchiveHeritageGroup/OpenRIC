...
namespace OpenRic3dModel\Controllers;
...
class Model3dController extends Controller
{
    ...
    public function browse(Request $request)
    {
        ...
        return view('openric-3d-model::browse', [
            'models' => $models,
    ...
    public function index(Request $request)
    {
        ...
        return view('openric-3d-model::index', [
            'models' => $models,
            'total' => $total,
            'page' => $page,
            'totalPages' => $totalPages,
    ...
    public function view(int $id)
    {
        ...
        return view('openric-3d-model::view', [
            'model' => $model,
            'hotspots' => $hotspots,
            'object' => $object,
        ]);
    ...
    public function edit(Request $request, int $id)
    {
        ...
        return view('openric-3d-model::edit', [
            'model' => $model,
            'hotspots' => $hotspots,
        ]);
    }
    ...
    public function embed(int $id)
    {
        ...
        return view('openric-3d-model::embed', [
            'model' => $model,
            'hotspots' => $hotspots,
        ]);
    }
    ...
    public function upload(Request $request, int $objectId)
    {
        ...
        return view('openric-3d-model::upload', [
            'object' => $object,
    ...
    public function settings(Request $request)
    {
        ...
        return view('openric-3d-model::settings', [
    ...
    public function triposr(Request $request)
    {
        ...
        return view('openric-3d-model::triposr', [
            'settings' => $settingsRaw,
            'health' => $health,
            'stats' => $stats,
