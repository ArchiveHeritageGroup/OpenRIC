...
namespace OpenRic\Forms\Controllers;

use OpenRic\Forms\Services\FormService;
...
class FormsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('forms::index', compact('templates', 'stats'));
    }
    ...
    public function browse(Request $request)
    {
        ...
        return view('forms::browse', compact('templates', 'formTypes', 'type', 'search'));
    }
    ...
    public function templates(Request $request)
    {
        ...
        return view('forms::templates', compact('templates', 'type'));
    }
    ...
    public function templateCreate(Request $request)
    {
        ...
        return view('forms::template-create');
    }
    ...
    public function builder(int $id)
    {
        ...
        return view('forms::builder', compact('template', 'fields', 'fieldTypes'));
    }
    ...
    public function preview(int $id)
    {
        ...
        return view('forms::preview', compact('template', 'fields'));
    }
    ...
    public function assignments()
    {
        ...
        return view('forms::assignments', compact('assignments', 'templates'));
    }
    ...
    public function assignmentCreate(Request $request)
    {
        ...
        return view('forms::assignment-create', compact('templates'));
    }
    ...
    public function library()
    {
        ...
        return view('forms::library', compact('library'));
    }
    ...
    public function admin()
    {
        ...
        return view('forms::admin', compact('templates', 'stats'));
    }
