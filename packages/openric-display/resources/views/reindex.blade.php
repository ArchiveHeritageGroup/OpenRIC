{{--
  Elasticsearch Reindex — reindex.blade.php
  Adapted from Heratio ahg-display reindex.blade.php
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-success mb-3">
                    <i class="fas fa-check-circle me-2"></i>Display fields are present in the Elasticsearch mapping.
                </div>
                @else
                <div class="alert alert-warning mb-3">
                    <i class="fas fa-exclamation-triangle me-2"></i>Display fields are NOT in the Elasticsearch mapping. You need to update the mapping first.
                </div>
                <form method="post" action="{{ route('display.reindex') }}">
                    @csrf
                    <input type="hidden" name="action" value="update_mapping">
                    <button type="submit" class="btn btn-warning"><i class="fas fa-plus me-1"></i> Add Display Fields to Mapping</button>
                </form>
                @endif
            </div>
        </div>
