{{--
  Display Settings Section for OpenRiC Settings Dashboard
  Adapted from Heratio ahg-display _display-settings-section.blade.php
--}}
...
<div class="settings-section" id="displaySettingsSection">
    ...
    <div class="collapse" id="displaySettingsContent">
        <div class="settings-section-body">
            @include('display::_display-settings-form')
        </div>
    </div>
</div>
