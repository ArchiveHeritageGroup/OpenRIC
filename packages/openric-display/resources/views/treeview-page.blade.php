{{--
  Treeview Page — treeview-page.blade.php
  Adapted from Heratio ahg-display treeview-page.blade.php
--}}
...
@section('content')
  ...
  @if(isset($rows) && count($rows))
    ...
    @if(isset($pager))@include('core::components.pager', ['pager' => $pager])@endif
  @else
