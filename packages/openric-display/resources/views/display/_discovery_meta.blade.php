{{--
  Discovery metadata footer -- _discovery_meta.blade.php
  Adapted from Heratio ahg-display::display._discovery_meta (62 lines)
  Per-result discovery metadata (relevance score, match reasons, explanation)
--}}
@php
