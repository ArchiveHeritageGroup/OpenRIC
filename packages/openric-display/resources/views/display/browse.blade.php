{{--
  ...
  Adapted from Heratio ahg-display::display.browse (444 lines)
  Route names: display.* instead of glam.*
  View namespace: openric-display:: instead of ahg-display::
--}}
...
@php
  ...
  // Helper: build display browse URL with filter params
  function displayBrowseUrl($fp, $add = [], $remove = []) {
...
@if(($viewMode ?? 'card') !== 'full')
  ...
  <div class="row">
    ...
    <div id="sidebar" class="col-md-3" role="complementary" aria-label="Filters and navigation">
      ...
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="true" aria-controls="facetType" data-bs-toggle="collapse" data-bs-target="#facetType" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetType" class="collapse show">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($typeFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['type']) }}" class="text-decoration-none small {{ empty($typeFilter) ? 'text-white' : '' }}">
                All
              </a>
            </li>
            @if(!empty($types))
              @foreach($types as $type)
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($typeFilter ?? '') === $typeKey ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['type' => $typeKey]) }}"
      ...
      {{-- Creator facet --}}
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="false" aria-controls="facetCreator" data-bs-toggle="collapse" data-bs-target="#facetCreator" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetCreator" class="collapse">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($creatorFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['creator']) }}" class="text-decoration-none small {{ empty($creatorFilter) ? 'text-white' : '' }}">All</a>
            </li>
            @if(!empty($creators))
              @foreach($creators as $creator)
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($creatorFilter ?? '') == $creator->id ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['creator' => $creator->id]) }}"
      ...
      {{-- Place facet --}}
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="false" aria-controls="facetPlace" data-bs-toggle="collapse" data-bs-target="#facetPlace" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetPlace" class="collapse">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($placeFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['place']) }}" class="text-decoration-none small {{ empty($placeFilter) ? 'text-white' : '' }}">All</a>
            </li>
            @if(!empty($places))
              @foreach($places as $place)
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($placeFilter ?? '') == $place->id ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['place' => $place->id]) }}"
      ...
      {{-- Subject facet --}}
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="false" aria-controls="facetSubject" data-bs-toggle="collapse" data-bs-target="#facetSubject" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetSubject" class="collapse">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($subjectFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['subject']) }}" class="text-decoration-none small {{ empty($subjectFilter) ? 'text-white' : '' }}">All</a>
            </li>
            @if(!empty($subjects))
              @foreach($subjects as $subject)
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($subjectFilter ?? '') == $subject->id ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['subject' => $subject->id]) }}"
      ...
      {{-- Genre facet --}}
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="false" aria-controls="facetGenre" data-bs-toggle="collapse" data-bs-target="#facetGenre" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetGenre" class="collapse">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($genreFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['genre']) }}" class="text-decoration-none small {{ empty($genreFilter) ? 'text-white' : '' }}">All</a>
            </li>
            @if(!empty($genres))
              @foreach($genres as $genre)
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($genreFilter ?? '') == $genre->id ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['genre' => $genre->id]) }}"
      ...
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="false" aria-controls="facetLevel" data-bs-toggle="collapse" data-bs-target="#facetLevel" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetLevel" class="collapse">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($levelFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['level']) }}" class="text-decoration-none small {{ empty($levelFilter) ? 'text-white' : '' }}">All</a>
            </li>
            @if(!empty($levels))
              @foreach($levels as $level)
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($levelFilter ?? '') == $level->id ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['level' => $level->id]) }}"
      ...
      @endphp
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="false" aria-controls="facetMedia" data-bs-toggle="collapse" data-bs-target="#facetMedia" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetMedia" class="collapse">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($mediaFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['media']) }}" class="text-decoration-none small {{ empty($mediaFilter) ? 'text-white' : '' }}">All</a>
            </li>
            @if(!empty($mediaTypes))
              @foreach($mediaTypes as $mt)
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($mediaFilter ?? '') == $mt->media_type ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['media' => $mt->media_type]) }}"
      ...
      {{-- Repository facet --}}
      <div class="card mb-2">
        <div class="card-header py-2 cursor-pointer" role="button" tabindex="0" aria-expanded="false" aria-controls="facetRepo" data-bs-toggle="collapse" data-bs-target="#facetRepo" style="background:var(--openric-primary, #1d6a52);color:#fff">
        ...
        <div id="facetRepo" class="collapse">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ empty($repoFilter) ? 'active' : '' }}">
              <a href="{{ displayBrowseUrl($fp, [], ['repo']) }}" class="text-decoration-none small {{ empty($repoFilter) ? 'text-white' : '' }}">All</a>
            </li>
            @if(!empty($repositories))
              @foreach($repositories as $repo)
                <li class="list-group-item d-flex justify-content-between align-items-center py-1 {{ ($repoFilter ?? '') == $repo->id ? 'active' : '' }}">
                  <a href="{{ displayBrowseUrl($fp, ['repo' => $repo->id]) }}"
    ...
    <div id="main-column" class="col-md-9" role="main">
      @include('openric-display::display._advanced-search')
      @include('openric-display::display._browse_content')
    </div>
...
<div class="modal fade" id="semanticSearchModal" tabindex="-1" aria-labelledby="semanticSearchModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="GET" action="{{ route('display.browse') }}">
