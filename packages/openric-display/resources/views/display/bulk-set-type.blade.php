{{--
  Bulk Set Object Types — display/bulk-set-type.blade.php
  Adapted from Heratio ahg-display display/bulk-set-type.blade.php
--}}
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('display.bulk.set.type') }}">
            ...
            <div class="mb-4">
              ...
              @error('collection_id')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
            </div>
              ...
              @if(!empty($collectionTypes) && count($collectionTypes))
                <div class="row">
                  @foreach($collectionTypes as $type)
                    @php $typeCode = $type->code ?? $type->name ?? ''; $icon = getTypeIcon($typeCode); @endphp
            ...
            <div class="d-flex justify-content-between">
              <a href="{{ route('display.index') }}" class="btn btn-outline-secondary">Cancel</a>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <ul class="small">
            ...
            <li><strong>Library:</strong> Bibliographic view</li>
            <li><strong>DAM:</strong> Visual grid/lightbox</li>
          </ul>
