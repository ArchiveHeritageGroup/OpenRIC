...
namespace OpenRicGis\Controllers;
...
class GisController extends Controller
{
    ...
    public function bbox(Request $request)
    {
        ...
        return view('openric-gis::bbox', compact('results', 'north', 'south', 'east', 'west'));
    }
    ...
    public function radius(Request $request)
    {
        ...
        return view('openric-gis::radius', compact('lat', 'lng', 'radiusKm'));
    }
    ...
    public function geojson(Request $request)
    {
        ...
        return view('openric-gis::geojson', compact('features'));
    }
}
