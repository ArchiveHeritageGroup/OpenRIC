...
@section('content')
<div class="d-flex align-items-center mb-3"><i class="fas fa-3x fa-stream me-3"></i><div><h1 class="mb-0">Workflow Timeline</h1></div></div>
<div class="timeline">
    @forelse($events ?? [] as $event)
    <div class="timeline-item d-flex mb-3">
        <div class="timeline-marker me-3"><div class="rounded-circle d-flex align-items-center justify-content-center" style="width:40px;height:40px;background:var(--bs-primary);color:#fff"><i class="fas fa-{{ $event->icon ?? 'circle' }}"></i></div></div>
